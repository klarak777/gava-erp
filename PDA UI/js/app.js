...
import { renderLogin } from './views/login.js?v=0.9.3.1';
import { renderDashboard } from './views/dashboard.js?v=0.9.3.1';
import { renderCommission } from './views/commission.js?v=0.9.3.1';
import { renderConsolidation } from './views/consolidation.js?v=0.9.3.1';
import { renderScanPallet } from './views/scanPallet.js?v=0.9.3.1';
