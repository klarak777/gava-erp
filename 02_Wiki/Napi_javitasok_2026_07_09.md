...
- **Partner nevek összevonása (AGROPONIENTE / AGROPONIENTE NATURAL):** A backend kamion-lekérdező végpontját (`/api/v1/shipments/:id`) felkészítettük arra, hogy az "AGROPONIENTE" és "AGROPONIENTE NATURAL" neveket egyenértékűnek tekintse. Így ha a frontenden összevontan kezeljük őket egy fuvar alatt (pl. a H196/3 alfuvarban), a szerver mindkét névhez tartozó tételeket (pl. `MELON GALIA 7PZS IFCO`) hiánytalanul visszaadja.
