/**
 * GAVA ERP – ALDI Stock modul
 */

export function renderAldiStock(container, windowManager) {
  ...
  wrapper.innerHTML = `
    <div style="display:flex; align-items:center; gap:10px;">
      ...
      <div>
        ...
        <p style="margin:0; font-size:12px; color:var(--text-muted, #64748b);">ALDI készletnyilvántartás és raktári állapotok</p>
      </div>
    </div>
    ...
    <div class="access-form-view" style="background:#ffffff; border:1px solid var(--border, #cbd5e1); border-radius:12px; padding:32px; text-align:center; color:#64748b; max-width:650px;">
      ...
      <h3 style="margin:0 0 6px 0; font-size:16px; font-weight:700; color:#1e293b;">ALDI Stock modul</h3>
      <p style="margin:0; font-size:13px;">Az ALDI Stock funkciók kidolgozása a következő fázisban érkezik.</p>
    </div>
  `;
